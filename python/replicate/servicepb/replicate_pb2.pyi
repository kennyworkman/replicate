...
class RemoteExperimentRequest(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    scriptPath: typing___Text = ...
    instance: typing___Text = ...
    numWorkers: builtin___int = ...
    ...
    def __init__(self,
        *,
        ...
        instance : typing___Optional[typing___Text] = None,
        numWorkers : typing___Optional[builtin___int] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"experiment",b"experiment"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"experiment",b"experiment",u"instance",b"instance",u"numWorkers",b"numWorkers",u"scriptPath",b"scriptPath"]) -> None: ...
type___RemoteExperimentRequest = RemoteExperimentRequest

class RemoteExperimentReply(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
...
type___RemoteExperimentReply = RemoteExperimentReply
